...
import { StudentLinkEntry } from '../features/student/components/StudentLinkEntry';
...
const ResultDetails = lazy(() => import('../features/results/components/ResultDetails').then((m) => ({ default: m.ResultDetails })));

const SchoolDashboard = lazy(() => import('../features/school/components/SchoolDashboard').then((m) => ({ default: m.SchoolDashboard })));
const AdminExams = lazy(() => import('../features/staff/components/AdminExams').then((m) => ({ default: m.AdminExams })));
const AdminCreateExam = lazy(() => import('../features/staff/components/AdminCreateExam').then((m) => ({ default: m.AdminCreateExam })));
