...
export const OfflineSubmissionSafeWall: React.FC<OfflineSubmissionSafeWallProps> = ({
  ...
  useEffect(() => {
    ...
    const answersChecksum = (answers.filter((answer) => answer !== null && answer !== undefined).length * 17).toString(16).toUpperCase();
        ...
        <Card className="border-rose-200 shadow-2xl rounded-[32px] overflow-hidden bg-white border-2">
          ...
          <CardContent className="p-5 sm:p-8 space-y-6">
            ...
            <div className="text-slate-600 text-xs font-medium space-y-3 leading-relaxed">
              <p>
                Your device disconnected from school servers during transmission. To protect your grade, we have compiled, sealed, and saved
                all answers directly to your browser's persistent cache.
              </p>
