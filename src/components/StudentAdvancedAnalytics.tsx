...
export const StudentAdvancedAnalytics: React.FC<AdvancedAnalyticsProps> = ({ attempts }) => {
  ...
  const scatterData = useMemo(() => {
    ...
    return attempts.map((attempt) => ({
      name: attempt.examTitle || 'Exam',
      accuracy: attempt.accuracy || (attempt.score / (attempt.answers.length * 4)) * 100, // Normalized logic
      avgTime: attempt.avgTimePerCorrect || 18,
      score: attempt.score
    }));
  }, [attempts]);
    ...
    <div className="space-y-11 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-11">
        ...
        <Card className="bg-gradient-to-br from-[#13162C] to-[#121326] border border-[#20254C] rounded-[32px] shadow-2xl relative overflow-hidden flex flex-col group min-w-[280px] w-full">
          ...
          <CardContent className="p-3 md:p-8 pb-4 h-[300px] md:h-[380px]">
              ...
              <ScatterChart margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
                ...
                <XAxis
                  ...
                  label={{
                    ...
                    position: 'bottom',
                    offset: 0,
                    className: 'text-[10px] uppercase font-black tracking-widest fill-slate-400'
                  }}
                  stroke="#2F365F"
            ...
            <ResponsiveContainer width="100%" height="100%">
              <RadarChart cx="50%" cy="50%" outerRadius="75%" data={subjectPerformance}>
                ...
                <Radar
                  ...
                  fillOpacity={0.25}
                />
                <Radar name="Explorer Raw Index" dataKey="student" stroke="#6366f1" strokeWidth={3} fill="#6366f1" fillOpacity={0.15} />
          ...
          <CardContent className="px-5 md:px-8 pb-5 md:pb-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
              {[
                ...
                <div
                  key={i}
                  className="p-6 bg-[#121429] rounded-[24px] border border-[#1E2342] flex flex-col items-center text-center group hover:bg-[#151730] hover:border-[#2C3362] transition-all duration-300"
                >
