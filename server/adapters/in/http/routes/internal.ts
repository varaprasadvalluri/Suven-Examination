...
import { GradingTaskDto } from '../../../../application/ports/GradingDispatcher';
import { gradeAttemptService, documentStore } from '../../../../composition';
...
router.post(
  ...
  asyncHandler(async (req: any, res) => {
    ...
    try {
      await gradeAttemptService.grade(dto);
