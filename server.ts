...
import healthRouter from './server/adapters/in/http/routes/health';
import clientErrorsRouter from './server/adapters/in/http/routes/clientErrors';
import cloudinaryRouter from './server/adapters/in/http/routes/cloudinary';
import firebaseStorageRouter from './server/adapters/in/http/routes/firebaseStorage';
import gatekeeperRouter from './server/adapters/in/http/routes/gatekeeper';
import dbRouter from './server/adapters/in/http/routes/db';
import authRoutesRouter from './server/adapters/in/http/routes/authRoutes';
import examsRouter from './server/adapters/in/http/routes/exams';
import gcpRouter from './server/adapters/in/http/routes/gcp';
import adminDbRouter from './server/adapters/in/http/routes/adminDb';
import reportsRouter from './server/adapters/in/http/routes/reports';
import internalRouter from './server/adapters/in/http/routes/internal';
import schoolControllerV1 from './server/adapters/in/http/routes/v1/SchoolController';
import loginOptionsControllerV1 from './server/adapters/in/http/routes/v1/LoginOptionsController';
import studentControllerV1 from './server/adapters/in/http/routes/v1/StudentController';
import examQuestionControllerV1 from './server/adapters/in/http/routes/v1/ExamQuestionController';
import attemptControllerV1 from './server/adapters/in/http/routes/v1/AttemptController';
import adminStaffControllerV1 from './server/adapters/in/http/routes/v1/AdminStaffController';
import studentDashboardControllerV1 from './server/adapters/in/http/routes/v1/StudentDashboardController';
import subjectCategoryControllerV1 from './server/adapters/in/http/routes/v1/SubjectCategoryController';
import academicLevelControllerV1 from './server/adapters/in/http/routes/v1/AcademicLevelController';
import resourceControllerV1 from './server/adapters/in/http/routes/v1/ResourceController';
import { errorHandler } from './server/adapters/in/http/middleware/errorHandler';
import { openApiSpec } from './server/swagger';
import { requireSession, requireRole } from './server/adapters/in/http/middleware/requireSession';
import { flushQueue, getQueueDepth } from './server/adapters/out/firestore/writeQueue';
