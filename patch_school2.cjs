...
content = content.replace(/return \(\s*<div className="school-section">/, loadingBlock + '    <div className="school-section">');
fs.writeFileSync('src/components/SchoolDashboard.tsx', content);
console.log("Patched SchoolDashboard loading again");
